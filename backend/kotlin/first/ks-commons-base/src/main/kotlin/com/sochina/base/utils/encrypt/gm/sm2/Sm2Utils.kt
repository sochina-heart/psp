...
import com.sochina.base.utils.encrypt.gm.sm2.SM2Helper.hash
import com.sochina.base.utils.encrypt.gm.sm2.SM2Helper.toByteArray
...
object SM2Utils {
    ...
    fun decrypt(input: String, privateKeyStr: String): String? {
    ...
    fun encrypt(input: String?): String? {
        return if (input.isNullOrBlank()) {
            ...
            encrypt(input, PUBLIC_KEY_VALUE)
        }
    }
    ...
    fun decrypt(input: String?): String? {
        return if (input.isNullOrBlank()) {
            ...
            decrypt(input, PRIVATE_KEY_VALUE)
        }
    }
}
