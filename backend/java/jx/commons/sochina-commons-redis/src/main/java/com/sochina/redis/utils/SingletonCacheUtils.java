...
public enum SingletonCacheUtils {
    INSTANCE;
    private static final Logger LOGGER = LoggerFactory.getLogger(SingletonCacheUtils.class);
    private final RedisTemplate redisTemplate;

    private SingletonCacheUtils() {
        redisTemplate = SpringUtil.getBean("redisTemplate");
    }

    public static SingletonCacheUtils getInstance() {
        return INSTANCE;
    }
