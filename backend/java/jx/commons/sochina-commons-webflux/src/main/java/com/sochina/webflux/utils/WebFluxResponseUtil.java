...
public class WebFluxResponseUtil {
    ...
    public static Mono<Void> webFluxResponseWriter(ServerHttpResponse response, HttpStatus status, Object value) {
        return webFluxResponseWriter(response, status, value, R.FAIL);
    }
    ...
    public static Mono<Void> webFluxResponseWriter(ServerHttpResponse response, String contentType, HttpStatus status, Object value, int code) {
        ...
        DataBuffer dataBuffer = response.bufferFactory().wrap(GsonUtils.toJson(result).getBytes(StandardCharsets.UTF_8));
