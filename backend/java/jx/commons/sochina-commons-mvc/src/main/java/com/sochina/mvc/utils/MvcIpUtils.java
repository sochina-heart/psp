...
public class MvcIpUtils {
    private static final Logger LOGGER = LoggerFactory.getLogger(MvcIpUtils.class);
    ...
    private static final String REGX_IP_WILDCARD = "(((\\*\\.){3}\\*)|(" + REGX_0_255 + "(\\.\\*){3})|(" + REGX_0_255 + "\\." + REGX_0_255 + ")(\\.\\*){2}" + "|((" + REGX_0_255 + "\\.){3}\\*))";
    ...
    public static String getIpAddr(HttpServletRequest request) {
        ...
        if (StringUtils.isNotBlank(ip)) {
            ip = ip.contains(Constants.COMMA) ? ip.split(Constants.COMMA)[0] : ip;
        }
