package com.sochina.mvc.utils.poi;
...
import com.sochina.mvc.annotation.excel.Excel;
import com.sochina.mvc.annotation.excel.Excels;
import com.sochina.mvc.config.SochinaConfig;
import com.sochina.mvc.utils.ReflectUtils;
import com.sochina.mvc.utils.poi.file.FileTypeUtils;
import com.sochina.mvc.utils.poi.file.PoiFileUtils;
import com.sochina.mvc.utils.poi.file.PoiImageUtils;
...
public class ExcelUtil<T> {
                    ...
                    if (StringUtils.isNotNull(fieldType)) {
                        ...
                        if (StringUtils.isNotEmpty(attr.targetAttr())) {
                            ...
                            if (image == null) {
                                ...
                                val = PoiFileUtils.writeImportBytes(data);
                            }
                        }
    ...
    public void setCellVo(Object value, Excel attr, Cell cell) {
        if (Excel.ColumnType.STRING == attr.cellType()) {
            ...
            if (StringUtils.isNotEmpty(imagePath)) {
                byte[] data = PoiImageUtils.getImage(imagePath);
    ...
    public void setPromptOrValidation(Sheet sheet, String[] textlist, String promptContent, int firstRow, int endRow, int firstCol, int endCol) {
        ...
        // 设置数据有效性加载在哪个单元格上,四个参数分别是：起始行、终止行、起始列、终止列、要设置的sheet、数据验证帮助、约束、提示内容
        setDataValidity(firstRow, endRow, firstCol, endCol, sheet, helper, constraint, promptContent);
    }
     ...
     * @param promptContent 提示内容
     */
    public void setDataValidity(int firstRow, int endRow, int firstCol, int endCol, Sheet sheet, DataValidationHelper helper, DataValidationConstraint constraint, String promptContent) {
    ...
    public String dataFormatHandlerAdapter(Object value, Excel excel) {
        try {
            ...
            LOGGER.error("不能格式化数据 {}", excel.handler());
        }
    ...
    public String getAbsoluteFile(String filename) {
        String downloadPath = SochinaConfig.getDownloadPath() + filename;
